/// by denis putra
/// klo mau recode kasih credit ajg
const
	{
		WAConnection,
		MessageType,
...
prefa = '-'
fake = 'SYAHRIBOT-2'
owner = '6285893123964' //ganti pake no lu
numbernye = '0'
...
const sekarang = new Date().getTime();
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek })
		}
		const simir = (teks) => {
...
console.log(e)
  ...
  const sendMediaURL = async(to, url, text="", mids=[]) =>{
		   ...
		   const sendFakeStatus = (from, teks, faketeks) => {
				denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `Crew-Bot`, orderTitle: `Crew-Bot`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
			}
...
\`\`\`@⁨${bugsol.split('@')[0]} Mengirim Bug Digrup ${groupName}\`\`\``
 ...
 denz.sendMessage(mek.key.remoteJid, tekuss, MessageType.text, { contexInfo: { mentionedJid:[bugsol] }})
        ...
        switch (command) {
			   case 'menu':
			   case 'help':
		        const _0x1e67=['cUkvVIbkyw0GoIa','Dg9VBhnTzw51cUkuLca','zgvSzxrLcUkuNca','mty5mZq1ouvItfriEa','mtKZsLvuDMDO','B3rOzxjTzw51cGRIM74Gq29MzMvLcMH0DhbZoI8VC2f3zxjPys5JBY9Kzw5PC3b1DhjHcUkCHIbszxbVCNqGqNvNcMH0DhbZoI8VD2eUBwuVnJi4ntG2nJi5ntK0mGRINiCGu2nYAxb0ienYzxCGqM90cMH0DhbZoI8Vz2L0AhvIlMnVBs9Ky29Kzs1Kzw5Wys9JCMv3yM90cGOTienYzxDcB3rhzw4Y','ndK5otq3DfHdyLzg','oteWm25wzevkta','mJuWmvLXAKrHwG','nZi1ntqXt09ADgXZ','iqOk4Pw+ienYzwf0B3iGoIba','CMvHzezPBgvtEw5J','z3jVDxbTzw51cUkuNca','C3rPy2TLCM1LBNuk4PsCia','lsbiAsa','cUkvVIbuyw5Nz2fSidOG','mebZlNDOyxrZyxbWlM5LDa','lI9Kzw56lMPWzW','C2vUze1LC3nHz2u','nZa4otL3AgDxquK','uhvIBgLJ','nJi4ntG2nJi5ntK0mKbZlNDOyxrZyxbWlM5LDa','Aw1Hz2uVANbLzW','mtKXAurQtg5A','yMf0CMvP','C3bLzwqkcUkDJYaQtgLZDcbnzw51kGRILjWG','mdaWmdaWmdaWma','owL2zxvpAW','C3rHDhvZcUkuNca','y3jLD2jVDc5WBMC','u2vSzG','ndCZowfVCM9WsW','surs','cUkvVIbiyxjPidOG','B3DUzxjTzw51cUkuNca','BgvUz3rO','Dxb0Aw1L','BwfRzxjTzw51cUkuNca',''];function _0x3218(_0x56c601,_0x4367be){_0x56c601=_0x56c601-0x1d4;let _0x1e67bf=_0x1e67[_0x56c601];if(_0x3218['LFVPai']===undefined){var _0x321847=function(_0x16db80){const _0x3ca83f='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';let _0x3d42ee='';for(let _0x5da9f5=0x0,_0x30b16a,_0x4e28a5,_0x944f57=0x0;_0x4e28a5=_0x16db80['charAt'](_0x944f57++);~_0x4e28a5&&(_0x30b16a=_0x5da9f5%0x4?_0x30b16a*0x40+_0x4e28a5:_0x4e28a5,_0x5da9f5++%0x4)?_0x3d42ee+=String['fromCharCode'](0xff&_0x30b16a>>(-0x2*_0x5da9f5&0x6)):0x0){_0x4e28a5=_0x3ca83f['indexOf'](_0x4e28a5);}return _0x3d42ee;};_0x3218['ZgLfaH']=function(_0x4d3a49){const _0x10eb31=_0x321847(_0x4d3a49);let _0x3aa0ce=[];for(let _0x497a2a=0x0,_0x2e6e85=_0x10eb31['length'];_0x497a2a<_0x2e6e85;_0x497a2a++){_0x3aa0ce+='%'+('00'+_0x10eb31['charCodeAt'](_0x497a2a)['toString'](0x10))['slice'](-0x2);}return decodeURIComponent(_0x3aa0ce);},_0x3218['EDaOtZ']={},_0x3218['LFVPai']=!![];}const _0x5273b8=_0x1e67[0x0],_0x2d76da=_0x56c601+_0x5273b8,_0x1bfdab=_0x3218['EDaOtZ'][_0x2d76da];return _0x1bfdab===undefined?(_0x1e67bf=_0x3218['ZgLfaH'](_0x1e67bf),_0x3218['EDaOtZ'][_0x2d76da]=_0x1e67bf):_0x1e67bf=_0x1bfdab,_0x1e67bf;}const _0x45b95c=_0x3218;(function(_0x3b9427,_0x5f344b){const _0x4a4d6e=_0x3218;while(!![]){try{const _0x40c24c=parseInt(_0x4a4d6e(0x1db))*-parseInt(_0x4a4d6e(0x1ef))+-parseInt(_0x4a4d6e(0x1dd))+-parseInt(_0x4a4d6e(0x1f3))*parseInt(_0x4a4d6e(0x1d8))+parseInt(_0x4a4d6e(0x1dc))*parseInt(_0x4a4d6e(0x1eb))+parseInt(_0x4a4d6e(0x1da))+parseInt(_0x4a4d6e(0x1d7))+-parseInt(_0x4a4d6e(0x1e7));if(_0x40c24c===_0x5f344b)break;else _0x3b9427['push'](_0x3b9427['shift']());}catch(_0x322403){_0x3b9427['push'](_0x3b9427['shift']());}}}(_0x1e67,0xd6617),dtod=_0x45b95c(0x1e9),runtime=process[_0x45b95c(0x1f8)]());let batanu=global[_0x45b95c(0x1ec)][global[_0x45b95c(0x1ec)][_0x45b95c(0x1f7)]-0x1];const crewbot=fs['readFileSync'](_0x45b95c(0x1f1)),menu=_0x45b95c(0x1e2)+pushname+_0x45b95c(0x1de)+dtod['split']('@')[0x0]+'\x0a╾\x20Battery\x20:\x20'+batanu+'%\x0a╾\x20Status\x20:\x20'+(publik?_0x45b95c(0x1e8):_0x45b95c(0x1f2))+_0x45b95c(0x1d4)+jmn+_0x45b95c(0x1f5)+week+'\x20'+weton+_0x45b95c(0x1e3)+calender+_0x45b95c(0x1fa)+prefix+_0x45b95c(0x1d6)+prefix+_0x45b95c(0x1f0)+prefix+'runtime\x0a└\x20'+prefix+_0x45b95c(0x1ed)+prefix+_0x45b95c(0x1f6)+prefix+_0x45b95c(0x1f9)+prefix+'downloadmenu\x0a├\x20'+prefix+_0x45b95c(0x1e0)+prefix+_0x45b95c(0x1e1)+prefix+_0x45b95c(0x1d5)+prefix+_0x45b95c(0x1d9);denz[_0x45b95c(0x1e6)](from,crewbot,image,{'quoted':{'key':{'fromMe':![],'participant':_0x45b95c(0x1e4),...from?{'remoteJid':'status@broadcast'}:{}},'message':{'productMessage':{'product':{'productImage':{'mimetype':_0x45b95c(0x1ea),'jpegThumbnail':fs[_0x45b95c(0x1df)](_0x45b95c(0x1e5))},'title':fake,'description':fake,'currencyCode':_0x45b95c(0x1f4),'priceAmount1000':_0x45b95c(0x1ee),'retailerId':fake,'productImageCount':0x1},'businessOwnerJid':_0x45b95c(0x1e4)}}},'contextInfo':{'forwardingScore':0x1fc,'isForwarded':!![],'mentionedJid':[dtod]},'caption':menu});
				break
				case 'ownermenu':
				case 'menuowner':
				try {
...
if (!isOwner) return reply(mess.only.ownerB)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    denz.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`crewbot2`}, MessageType.location)
